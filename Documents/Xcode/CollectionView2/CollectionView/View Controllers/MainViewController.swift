...
class MainViewController: UICollectionViewController {
	...
	override func viewDidLoad() {
        ...
        // Have "sticky" headers which remain at the top until a new one pushes them away
...
extension MainViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let park = dataSource.parkForItemAtIndexPath(indexPath)
        if let title = dataSource.titleForSectionAtIndexPath(indexPath), let state = park?.state {
            view.section = Section(title: title, stateCount: dataSource.numberOfParksInSection(indexPath.section), state: state)
        }
